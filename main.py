...
# nohup python3.8 main.py -s /home/ec2-user/SST-ETBD_Code/inputs/ > /home/ec2-user/SST-ETBD_Code/console_output/test_console1 &
# command prompt: -s "C:\Users\Cyrus\Documents\Emory\Lab\Dissertation Explorations\SST-ETBD_Code\inputs"
# username: ec2-user 
...
# 
# starttime = time.time()
# settings_folder = str(Path("C:/Users/Cyrus/Documents/Emory/Lab/Dissertation Explorations/SST-ETBD_Code/inputs"))
# 
# setting_files = glob.glob(f"{settings_folder}/*settings*.json")
# 
# a = Experiment_Runner(setting_files)
# endtime = time.time()
# print("runtime = {} seconds".format(endtime - starttime))
