...
training_data = pd.DataFrame([], columns=['rep','passed?','%','test_range','bx'])
...
for input_file in file_list:
    ...
    temp_training_data = pd.DataFrame([[rep_num,training_pass,test_percentage,training_test_range,\
                                        training_sum]], index =[rep_num],\
                                        columns=['rep','passed?','%','test_range','bx'])
